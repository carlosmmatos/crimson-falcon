...
| ------ | ------------ | ----------- |
| [**get_aggregate_v2**](AlertsApi.md#get_aggregate_v2) | **POST** /alerts/aggregates/alerts/v2 | retrieves aggregate values for Alerts across all CIDs |
...
| [**get_v2**](AlertsApi.md#get_v2) | **POST** /alerts/entities/alerts/v2 | retrieves all Alerts given their composite ids |
...
| [**query_v2**](AlertsApi.md#query_v2) | **GET** /alerts/queries/alerts/v2 | retrieves all Alerts ids that match a given query |
| [**update_v3**](AlertsApi.md#update_v3) | **PATCH** /alerts/entities/alerts/v3 | Perform actions on Alerts identified by composite ID(s) in request. Each action has a name and a description which describes what the action does. If a request adds and removes tag in a single request, the order of processing would be to remove tags before adding new ones in.   |


## get_aggregate_v2

> <DetectsapiAggregatesResponse> get_aggregate_v2(body, opts)
...
begin
  # retrieves aggregate values for Alerts across all CIDs
  result = api_instance.get_aggregate_v2(body, opts)
  p result
rescue Falcon::ApiError => e
  puts "Error when calling AlertsApi->get_aggregate_v2: #{e}"
end
```

#### Using the get_aggregate_v2_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<DetectsapiAggregatesResponse>, Integer, Hash)> get_aggregate_v2_with_http_info(body, opts)

```ruby
begin
  # retrieves aggregate values for Alerts across all CIDs
  data, status_code, headers = api_instance.get_aggregate_v2_with_http_info(body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DetectsapiAggregatesResponse>
rescue Falcon::ApiError => e
  puts "Error when calling AlertsApi->get_aggregate_v2_with_http_info: #{e}"
end
```
...
> <DetectsapiPostEntitiesAlertsV2ResponseSwagger> get_v2(body, opts)
...
begin
  # retrieves all Alerts given their composite ids
  result = api_instance.get_v2(body, opts)
  p result
rescue Falcon::ApiError => e
  puts "Error when calling AlertsApi->get_v2: #{e}"
end
```
...
> <Array(<DetectsapiPostEntitiesAlertsV2ResponseSwagger>, Integer, Hash)> get_v2_with_http_info(body, opts)

```ruby
begin
  # retrieves all Alerts given their composite ids
  data, status_code, headers = api_instance.get_v2_with_http_info(body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DetectsapiPostEntitiesAlertsV2ResponseSwagger>
rescue Falcon::ApiError => e
  puts "Error when calling AlertsApi->get_v2_with_http_info: #{e}"
end
```
...
> <DetectsapiAlertQueryResponse> query_v2(opts)
...
begin
  # retrieves all Alerts ids that match a given query
  result = api_instance.query_v2(opts)
  p result
rescue Falcon::ApiError => e
  puts "Error when calling AlertsApi->query_v2: #{e}"
end
```

#### Using the query_v2_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<DetectsapiAlertQueryResponse>, Integer, Hash)> query_v2_with_http_info(opts)

```ruby
begin
  # retrieves all Alerts ids that match a given query
  data, status_code, headers = api_instance.query_v2_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DetectsapiAlertQueryResponse>
rescue Falcon::ApiError => e
  puts "Error when calling AlertsApi->query_v2_with_http_info: #{e}"
end
```
...
> <DetectsapiResponseFields> update_v3(body, opts)
...
begin
  # Perform actions on Alerts identified by composite ID(s) in request. Each action has a name and a description which describes what the action does. If a request adds and removes tag in a single request, the order of processing would be to remove tags before adding new ones in.  
  result = api_instance.update_v3(body, opts)
  p result
rescue Falcon::ApiError => e
  puts "Error when calling AlertsApi->update_v3: #{e}"
end
```

#### Using the update_v3_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<DetectsapiResponseFields>, Integer, Hash)> update_v3_with_http_info(body, opts)

```ruby
begin
  # Perform actions on Alerts identified by composite ID(s) in request. Each action has a name and a description which describes what the action does. If a request adds and removes tag in a single request, the order of processing would be to remove tags before adding new ones in.  
  data, status_code, headers = api_instance.update_v3_with_http_info(body, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DetectsapiResponseFields>
rescue Falcon::ApiError => e
  puts "Error when calling AlertsApi->update_v3_with_http_info: #{e}"
end
```
